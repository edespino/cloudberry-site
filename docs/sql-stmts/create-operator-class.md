...
[ALTER OPERATOR CLASS](/docs/sql-stmts/alter-operator-class.md), [DROP OPERATOR CLASS](/docs/sql-stmts/drop-operator-class.md), [CREATE OPERATOR FAMILY](/docs/sql-stmts/create-operator-family.md), [ALTER OPERATOR FAMILY](/docs/sql-stmts/alter-operator-family.md), [CREATE FUNCTION](/docs/sql-stmts/create-function.md)

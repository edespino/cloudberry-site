...
A query (`SELECT` statement) that supplies the rows to be inserted. Refer to the [SELECT](/docs/sql-stmts/select.md) statement for a description of the syntax.
...
Possible limitations of the query clause are documented under [SELECT](/docs/sql-stmts/select.md).

## See also

[SELECT](/docs/sql-stmts/select.md)

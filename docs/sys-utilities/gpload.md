...
- The [gpfdist](/docs/sys-utilities/gpfdist.md) parallel file distribution program installed and in your `$PATH`. This program is located in `$GPHOME/bin` of your Apache Cloudberry server installation.

...
You can use the optional sequence_options clause to override the options of the sequence. See [CREATE SEQUENCE](/docs/sql-stmts/create-sequence.md) for details.
...
If a constraint is deferrable, this clause specifies the default time to check the constraint. If the constraint is `INITIALLY IMMEDIATE`, it is checked after each statement. This is the default. If the constraint is `INITIALLY DEFERRED`, it is checked only at the end of the transaction. You can alter the constraint check time with the [SET CONSTRAINTS](/docs/sql-stmts/set-constraints.md) command.
...
[ALTER TABLE](/docs/sql-stmts/alter-table.md), [DROP TABLE](/docs/sql-stmts/drop-table.md), [CREATE EXTERNAL TABLE](/docs/sql-stmts/create-external-table.md), [CREATE TABLE AS](/docs/sql-stmts/create-table-as.md), [CREATE TABLESPACE](/docs/sql-stmts/create-tablespace.md), [CREATE TYPE](/docs/sql-stmts/create-type.md)

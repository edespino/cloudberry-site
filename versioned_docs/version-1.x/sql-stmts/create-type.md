...
It is possible to create an enumerated type with zero labels, but such a type cannot be used to hold values before at least one label is added using [ALTER TYPE](/docs/sql-stmts/alter-type.md).
...
[ALTER TYPE](/docs/sql-stmts/alter-type.md), [CREATE DOMAIN](/docs/sql-stmts/create-domain.md), [CREATE FUNCTION](/docs/sql-stmts/create-function.md), [DROP TYPE](/docs/sql-stmts/drop-type.md)
